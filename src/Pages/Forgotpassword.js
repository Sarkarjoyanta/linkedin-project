...
const Forgotpassword = () => {
  ...
  return (
    <div className="bg-[#11175D] w-full h-screen flex justify-center items-center">
      ...
      <div className="bg-white p-5 rounded w-96">
        ...
        <div className="relative mt-8">
          ...
          <button
            ...
            className="bg-[#11175D] rounded font-nunito font-semibold text-xl text-white p-5 mt-5"
          >
            Update
          </button>
          <button className="bg-[#11175D] rounded font-nunito font-semibold text-xl text-white p-5 mt-5 ml-5">
